<header class="header nav__menu-page" id="header">
    <nav class="nav container">
        ...
        <div class="nav__menu" id="nav-menu">
            <ul class="nav__list">
                <li>
                    <a href="admin-commandes.php" class="nav__link">Commandes</a>
                </li>
                <li>
                    <a href="admin-modifier-produit.php" class="nav__link">Produits</a>
                </li>
                <li>
                    <a href="admin-messages.php" class="nav__link">Messages</a>
                </li>
                <li>
