...
--
ALTER TABLE `price`
  ADD CONSTRAINT `fk_product_price` FOREIGN KEY (`produit_id`) REFERENCES `produit` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `fk_product_size` FOREIGN KEY (`option_id`) REFERENCES `option_product` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
